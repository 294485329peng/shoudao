...
<body>
	<!-- <div class="youkuangjia"> -->
            ...
            <div class="mcontent_no_border">
                ...
                <div>
			    <form action="${ctx}/tinyWeb/insert.do" id="form" name="form" method="post" class="basic-grey registerform">
			    <input type="hidden" id="TEMPLATE_ID" name="TEMPLATE_ID" value="${record.TEMPLATE_ID }" />
			    ...
			    <span class="basic-grey-label-span" >模板图片 :</span>
			    ...
			    <input id="NAME" type="text" name="NAME" style="width: 250px;" value="${record.NAME }" datatype="s1-14" nullmsg="请填写名称！" errormsg="至少1个字,最多14个字！"/>
			    </label>
				<label style=" height: 50px;">
			    <span class="basic-grey-label-span">简介 :</span>
			    <input id="DESCRIPTION" type="text" style="width: 300px;" name="DESCRIPTION" value="${record.DESCRIPTION }" datatype="s1-40" nullmsg="请填写简介！" errormsg="至少1个字,最多40个字！"/>
			    </label>
			    <label style="margin-top: 10px; height: 50px;">
			    <span class="basic-grey-label-span">编号 :</span>
			    <input id="NUMBER" type="text" name="NUMBER" style="width: 250px;" value="${record.NUMBER }" datatype="s1-14" nullmsg="请填写编号！" errormsg="至少1个字,最多14个字！"/>
			    </label>
...
$(function(){
	...
	$(".registerform:eq(0)").Validform({
		...
		callback:function(data){
				if(data.status=="y"){
					$("#TEMPLATE_ID").val(data.obj.TEMPLATE_ID);
					setTimeout(function(){
