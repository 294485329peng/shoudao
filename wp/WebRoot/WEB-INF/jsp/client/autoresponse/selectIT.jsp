	...
	$(document).ready(function(){
		  ...
		  $("a[name='transmit']").on('click', function(){
			    ...
			    var IT_GROUP_ID = $(this).attr('IT_GROUP_ID');
			  	var IT_JSON = {"IT_ID":IT_ID,"PIC_URL":PIC_URL,"TITLE":TITLE,"AUTHOR":AUTHOR,"CREATE_TIME":CREATE_TIME,"IT_COUNT":IT_COUNT,"IT_GROUP_ID":IT_GROUP_ID};
...
<body>
	<div class="rightinfo">
	    <div class="tools">
	    	...
	    	<form id="queryForm" action="${ctx}/ar/selectIT.do" method="post">
	    ...
	    <a name="transmit" class="enter" IT_ID="${r.IT_ID }" PIC_URL="${r.PIC_URL }"  IT_GROUP_ID="${r.IT_GROUP_ID }" TITLE="${r.TITLE }" AUTHOR="${r.AUTHOR }" CREATE_TIME="${r.CREATE_TIME }" IT_COUNT="${r.IT_COUNT }">选择</a>
	    </div>
	    </li>
	    </c:forEach>
