...
<body>
	<div class="rightinfo">
	    ...
	    <a name="transmit" class="enter" PUBLISH="${r.PUBLISH}" IT_MEDIA_ID="${r.MEDIA_ID }" IT_ID="${r.IT_ID }" PIC_URL="${r.PIC_URL }" TITLE="${r.TITLE }" AUTHOR="${r.AUTHOR }" CREATE_TIME="${r.CREATE_TIME }" IT_COUNT="${r.IT_COUNT }">选择</a>
	    </div>
	    </li>
	    </c:forEach>
