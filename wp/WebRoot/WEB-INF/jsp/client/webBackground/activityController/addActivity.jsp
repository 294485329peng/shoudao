...
<body>
	<!-- <div class="youkuangjia"> -->
            ...
            <div class="mcontent_no_border">
                <div class="alert">
                    <p>注意：添加公司活动宣传页，详细填写信息后保存!</p>
                </div>
                <div>
			    <form action="${ctx}/acBC/insertActivity.do" id="activityForm" name="activityForm" method="post" class="basic-grey registerform">
			    ...
			    <input id="TITLE" type="text" name="TITLE" value="${record.TITLE }" datatype="s1-20" nullmsg="请填写标题！" errormsg="标题至少1个字,最多20个字！"/>
			    </label>
				<label style=" height: 50px;">
			    <span class="basic-grey-label-span">简介 :</span>
			    <input id="DESCRIPTION" type="text" style="width: 350px;" name="DESCRIPTION" value="${record.DESCRIPTION }" datatype="s1-35" nullmsg="请填写简介！" errormsg="简介至少1个字,最多35个字！"/>
			    </label>
			    ...
			    <label style="margin-top: 10px;">
				 ...
				 <input id="RESPONSE_TITLE" type="text" readonly="readonly" name="RESPONSE_TITLE" value="" style="margin-bottom: 0px;" datatype="*" nullmsg="请选择相应商品！"/>
				 </label>
				 <label style="margin-top: 10px;">
				 <span class="basic-grey-label-span"> 首页展示价格:</span>
				 <input id="SHOW_PRICE" type="text" name="SHOW_PRICE" value="" style="margin-bottom: 0px;width: 115px;" datatype="money" errormsg="请输入正确商品价格！">
				 </label>
				 </div>
				 <div id="activityRs" style="${record.RESPONSE == '2' || record.RESPONSE == '' || record.RESPONSE == null ? '' : 'display: none;'}">
			    <label>
