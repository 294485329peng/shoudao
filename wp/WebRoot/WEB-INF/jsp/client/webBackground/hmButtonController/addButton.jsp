...
<body>
	<!-- <div class="youkuangjia"> -->
            ...
            <div class="mcontent_no_border">
                <div class="alert">
                    <p>注意：以下是常用的地址：</p>
                    <p>1.微网站首页地址：http://www.wxplatform.top${ctx}/TWeb/bs/home.htmls?store=${record.GZH_ID }</p>
                	<p>2.微网站商品列表地址：http://www.wxplatform.top${ctx}/TWeb/goods/goodsList.htmls?store=${record.GZH_ID }</p>
                	<p>3.微网站活动列表地址：http://www.wxplatform.top${ctx}/TWeb/act/list.htmls?store=${record.GZH_ID }</p>
                	<p>4.用户中心地址：http://www.wxplatform.top${ctx}/MemberCenter/memberInfo.htmls?store=${record.GZH_ID }</p>
			    ...
			    <input id="DESCRIPTION" type="text" style="width: 300px;" name="DESCRIPTION" value="${record.DESCRIPTION }" datatype="s1-8" nullmsg="请填写简介！" errormsg="至少1个字,最多8个字！"/>
			    </label>
			    <label style="margin-top: 10px;">
				 <span class="basic-grey-label-span">URL地址:</span>
				 <input id="URL" type="text" name="URL" value="${record.URL }" style="margin-bottom: 0px;" datatype="url" nullmsg="请填写跳转地址！" errormsg="请填写正确URL地址，开头需：http://www.baidu.com！"/>
				 </label>
