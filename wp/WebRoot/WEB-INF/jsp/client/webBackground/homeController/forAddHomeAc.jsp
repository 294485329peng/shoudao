 ...
 /**
	...
	function save() {
		...
		var validateRule = [
		        			...
		        			{id:"INTRO",message:"简介不能为空！"},
		               	];
		BaseUtils.showWaitMsg();
		if(!formValidationFun(validateRule)) return;
		if($("#HAC_ID").val() == "" || $("#HAC_ID").val() == null){
			 $.ajax({
					url : $("#addHomeAcForm").attr("action"),
					type : "post",
					data : $("#addHomeAcForm").serialize(),
					dataType : "json",
...
<body>
    ...
    <form action="${ctx}/webBgAc/insertHomeAc.do" id="addHomeAcForm" name="addHomeAcForm" method="post" class="basic-grey">
    <input type="hidden" id="HAC_ID" name="HAC_ID" value="" />
    ...
    <label>
    <span>栏目 :</span>
    <input id="CATEGORY" name="CATEGORY" type="text"  style="width: 110px;" readonly="readonly"  value="首页底部活动"/>
    </label>
    <label>
    <span>简介 :</span>
    <input id="INTRO" name="INTRO" type="text"  value=""/>
    </label>
