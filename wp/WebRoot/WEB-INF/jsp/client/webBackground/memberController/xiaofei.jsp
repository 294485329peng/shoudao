...
<body>
         <div class="mcontent_no_border">
			    <form action="${ctx}/memberBC/insterXiaofeiMoney.do" id="activityForm" name="activityForm" method="post" class="basic-grey registerform">
			    <input type="hidden" id="OPEN_ID" name="OPEN_ID" value="${record.OPEN_ID }" />
			    <label style="margin-top: 10px; height: 50px;">
			    <span class="basic-grey-label-span">消费金额:</span>
			    <input  type="text" id="MONEY" name="MONEY" value="" datatype="money" ignore="ignore"  errormsg="最多12个位数字！"/>
			    </label>
				<label style=" height: 50px;">
			    <span class="basic-grey-label-span">消费积分 :</span>
			    <input  type="text" id="POINT" name="POINT" value="" datatype="n0-12"  ignore="ignore" errormsg="最多12个位数字！"/>
			    </label>
			    <label style=" height: 50px;">
			    <span class="basic-grey-label-span">获得积分 :</span>
			    <input  type="text" id="GET_POINT" name="GET_POINT" value="" datatype="n0-12" ignore="ignore" errormsg="最多12个位！"/>
			    </label>
			    <label style=" height: 50px;">
...
$(function(){
	...
	$(".registerform:eq(0)").Validform({
		...
		beforeSubmit:function(curform){
			...
			if("" == POINT && "" == MONEY && "" == GET_POINT){
				$.Showmsg("消费金额、消费积分、获得积分至少填写一项！");
				return false;
			}
