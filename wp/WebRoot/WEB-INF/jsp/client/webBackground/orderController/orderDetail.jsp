	...
	<div class="right_con" style="height: 100%">
		...
		<div class="tabs-panels">
			<div class="info-box order-info" style="display: block;">
				...
				<h3 ><a href=""  style="font-size: 15px;color: blue;">卖家信息</a></h3>
				<dl>
				<dt>昵称：</dt>
				<dd>
				<input type="text" name="" readonly="readonly" class="zero-input-text input-text input-text-readonly" value="${record.recordMember.GZH_NICK_NAME }" />
				</dd>
				<dt>真实姓名：</dt>
				...
				<dt>支付方式：</dt>
				<dd><input type="text" name="PAY_TYPE" readonly="readonly" class="zero-input-text input-text input-text-readonly" value="${record.recordOrder.PAY_TYPE }" /></dd>
				<dt>支付状态：</dt>
				<dd><input type="text" name="IS_PAY" readonly="readonly" class="zero-input-text input-text input-text-readonly" value="${record.recordOrder.IS_PAY }" /></dd>
				</dl>
				<dl>
				<dt>下单时间：</dt>
		...
		<div class="tabs-panels">
			<div class="info-box order-info" style="display: block;">
				...
				<dl>
				<dt> 订单状态 ： </dt>
				<dd><select name="" class="zero-select-base zero-select order-select">
