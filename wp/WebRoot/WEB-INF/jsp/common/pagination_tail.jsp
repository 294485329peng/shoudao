...
font-size: 14px;
			...
			<nav>
				  <ul class="pagination" style="float: right;">
				    ...
				    <!-- <li class="disabled">
				    	<div class="col-lg-1 col-xs-2" style="padding-left: 5px; padding-right: 5px; width: 70px; display: inline;">
				    	<input type="text" class="form-control" placeholder="跳转到" 
				    	onkeypress="var e=window.event||this;var c=e.keyCode||e.which;if(c==13)pageNow($(this).val());" onclick="this.select();"  style="padding-top: 0px; padding-bottom: 0px; height: 30px;">
				    	</div>
				    </li> -->
				    <li class="disabled">
...
<%-- <table width="100%" border="0" cellspacing="0" cellpadding="0" class="dsdgy">
	<tr>
		<td align="left" class="font_size">&nbsp;&nbsp;总记录数:${pageView.rowCount}条
		...
		<td align="right">
			<p class="pages_p">
				...
				<a href="javascript:void(0);" onclick="return pageNow('1');" class="font_size">首页</a>
				<a href="javascript:void(0);" onclick="return pageNow('${pageView.pageNow - 1}');" class="font_size">上一页</a>
				<c:forEach begin="${pageView.pageindex.startindex}"
					end="${pageView.pageindex.endindex}" var="key">
					<c:if test="${pageView.pageNow==key}">
						&nbsp;<span class="current" style="color: red;font-size: 20px;" class="font_size">
							${key}</span>
					</c:if>
					<c:if test="${pageView.pageNow!=key}">
						&nbsp;<a href="javascript:void(0);" onclick="return pageNow('${key}');" class="font_size">${key}</a>
					</c:if>
				</c:forEach>
				<a href="javascript:void(0);" onclick="return pageNow('${pageView.pageNow + 1}');" class="font_size">下一页</a>
				<a href="javascript:void(0);" onclick="return pageNow('${pageView.pageCount}');" class="font_size">尾页</a>
			</p>
		</td>
	</tr>
</table> --%>