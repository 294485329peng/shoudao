...
<div style="width:210px;overflow-x: hidden; overflow-y: auto;height: 100%;position:absolute; ">
<div class="center_left" style="width:186px;">
	<div class="left_tit clearfix" style="position:fixed;width:100%;"><i></i>${pName}</div>
	<div style="widht:100%;height:40px;"></div>
    <c:forEach items="${leftMenuList}" var="menuRec" varStatus="status">
    	<c:if test="${menuRec.MENU_LEVEL eq '2'}">
    		<div id="${menuRec.MENU_ID}" class="left_menu_box">
    			...
    			<ul class="ul_left" style="display: none;">
    					...
    					<c:if test="${menuRec1.IS_LEAF eq '0'}">
    						<li>
            					...
            					<c:forEach items="${leftMenuList}" var="menuRec2" varStatus="status">
            							<c:if test="${menuRec2.MENU_LEVEL eq '4'}">
