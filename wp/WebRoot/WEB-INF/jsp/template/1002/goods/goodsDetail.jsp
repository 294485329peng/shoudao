...
<div class="mall_main">
    ...
    <div class="des_goods">
        ...
        <p><span class="pr">服务</span><span>请联系商家电话预定</span></p>
        <p><span class="pr" style="padding-right: 0px;">快递信息：</span><span style="padding-right: 10px;">${goods.TRANSPORTATION_INFO }</span><span>运费：${goods.TRANSPORTATION_PICE }</span></p>
        <hr/>
