...
<body>
<div class="body">
<h3 class="fn-tit"  style="padding-bottom: 0px;background-color:#EEE9E9;padding-bottom: 5px;padding-top: 5px;"><a href="javascript:history.go(-1);" class="nback">返回</a><b class="tit">活动</b></h3>
