...
<div class="login-container">
	...
	<form action="${ctx }/TWebLogin/Member/loginCheck.htmls" class="registerform" method="post" id="loginForm ">
		...
		<div>
			<input type="password" name="password" class="password" placeholder="密码" datatype="s6-16" nullmsg="请填写密码！" errormsg="密码至少6位,最多16位！"/>
		</div>
...
function register(){
	window.location="${ctx}/TWebLogin/Member/register.htmls";
}
</script>
</html>