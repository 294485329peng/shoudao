...
<body>
	<div class="header_box">
		<div class="logo float_l" style="padding-top: 0px; margin-top: 5px; width: 154px;">
			<%-- <a href="${ctx }/main.do" target="_parent"><img src="${ctx}/skin/default/images/logo.png" width="200" height="50" /></a> --%>
			<a href="${ctx }/main.do" target="_parent">
			<img src="${ctx}/skin/default/images/logo1.png" width="80" title="系统首页" />
			
			<%-- <img src="${ctx}/skin/default/images/logo2.png" width="170" height="35" title="系统首页" /> --%>
			</a>
		</div>
		<div id="pic_list_1" class="head_ctrl"  style="width: 445px;">
