...
K.options = {
	...
	items : [
		...
		'source', '|','formatblock', 'fontname', 'fontsize','undo', 'redo', '|', 'emoticons','image','preview', 'template', 'code', 'cut', 'copy', 'paste',
		'plainpaste', 'wordpaste', '|', 'justifyleft', 'justifycenter', 'justifyright',
		'justifyfull', 'insertorderedlist', 'insertunorderedlist', 'quickformat',  
		 '|', 'forecolor', 'hilitecolor', 'bold',
		'italic', 'underline', 'strikethrough', 'lineheight', 'removeformat', '|', 'table', 'hr', 'baidumap', 'pagebreak',
		 'link', 'unlink'
	],
...
_extend(KUploadButton, {
	init : function(options) {
		...
		var html = [
			...
			hiddenElements.join(''),
			'<input type="button"style="width: 58px;" class="ke-button-common ke-button" value="' + title + '" />',
			'</span>',
        ...
        success: function (msg) {
            if (msg !== "") {
                ...
                $(img).each(function (i) {
                    var that = $(this);
                    if (that.attr("src").indexOf("http://") >= 0 || that.attr("src").indexOf("https://") >= 0) {
                        that.attr("src", "wp/fileUpload/image/" + str[i]);
