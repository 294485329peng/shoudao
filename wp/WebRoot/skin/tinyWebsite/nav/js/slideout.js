...
function Slideout(options) {
  ...
  if(this.navmenu.className.search('slideout-navmenu') === -1) { this.navmenu.className += ' slideout-navmenu'; }
...
/**
 * Toggles (open/close) slideout navmenu.
 */
...
Slideout.prototype._initTouchEvents = function() {
  ...
  this.panel.addEventListener(touch.start, function(eve) {
    ...
    self._preventOpen = (!self._touch || (!self.isOpen() && self.navmenu.clientWidth !== 0));
  });
