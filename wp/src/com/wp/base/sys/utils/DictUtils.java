...
import com.wp.base.sys.sys_dict.service.ISysDictService;
import com.wp.common.spring.ComponentFactory;
import com.wp.common.utils.CacheUtils;
...
public class DictUtils {
	...
	public void refreshDictCache(){
		logger.info("定时器执行：com.wp.base.sys.utils。DictUtils——refreshDictCache");
		@SuppressWarnings("unchecked")
		Map<String, List<Map>> dictMap = (Map<String, List<Map>>)CacheUtils.get(CacheUtils.DICT_CACHE,CACHE_DICT_MAP);
		//如果缓存中没有东西，则初始化所有字典项到缓存中
		if (dictMap==null){
